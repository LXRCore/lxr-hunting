...
description 'LXRCore v3 hunting: skin what the game killed, graded by the game, into catalog pelts, meat, trophies and carcasses'
version '3.0.0'
repository 'https://github.com/LXRCore/lxr-hunting'
